...
\begin{exercise}
  Cocokkan yang berikut ini dengan satu atau lebih lapisan model OSl:
a. berkomunikasi langsung dengan program aplikasi pengguna
B. Koreksi Kesalahan dan transmisi ulang
C. Antarmuka mekanik, listrik, dan fungsional
D. tanggung jawab untuk membawa frame antara node yang berdekatan
\end{exercise}
...
\begin{exercise}
 Cocokkan yang berikut ini dengan satu atau lebih lapisan model OSI:
A. layanan konversi Format dan kode
B. menetapkan, mengelola, dan mengakhiri sesi
C. memastikan transmisi data yang andal
d. prosedur Login dan logout
E. memberikan independensi dari perbedaan representasi data
\end{exercise}

\begin{solution}
a. presentation layer
b. session layer
c. transport, session, network layer
d. network layer
...
\begin{exercise}
Pada gambar 2.22, komputer A mengirim pesan ke komputer D melalui LANl, router Rl,dengan LAN2. Tampilkan Isi paket dan frame pada jaringan dan data link layer untuk setiap antarmuka hop.
...
\begin{exercise}
Pada gambar 2.22, asumsikan bahwa komunikasi adalah antara suatu proses yang berjalan padakomputer A dengan alamat port i dan proses yang berjalan di komputer D dengan port alamat j. menunjukkan isi paket dan frame pada jaringan, data link, dan lapisan transportasi untuk setiap hop
\end{exercise}
